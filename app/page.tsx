...
import { Layout, Palette, Component, FileCode, Star } from "lucide-react";
...
export default function Home() {
  ...
  const templates = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
      category: "E-commerce",
      downloads: 1892,
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
      category: "Blog",
      downloads: 1567,
    },
  ];
    ...
    <div className="container py-8">
      <section className="mb-12 text-center">
        ...
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
          A curated collection of beautiful, reusable code fragments for modern
          web development. Copy and paste into your projects.
        </p>
      </section>
